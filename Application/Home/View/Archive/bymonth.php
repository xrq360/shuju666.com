...
<head>
	...
	<title>{$month}泄露信息存档|数据牛 - www.shuju666.com</title>
		...
		<div class="row" style="margin-top:55px">
			...
			<div class="col-xs-10">
				<div class="well">
					...
					<span style="font-size:13px;color:#999">{$month}存档 >>> </span>
					<div class="tribe" style="background-color:#fff;">
						...
						<div class="tribe-list">
							<table style="table-layout:fixed;">
								...
								<tr>
									<td width="70%"><span class="tribe-list-text pull-left"> <a href="{:U('Archive/byday?d='.$vo['pltime'])}"><span class="glyphicon glyphicon-file"></span> {$vo.pltime} 泄露信息存档 </a></span></td>
									<td width="30%">{$vo.pltime} </td>
