		...
		<div class="modal-content" style="width:380px;">
			...
			<div class="modal-body">
				<form role="form" class="form-horizontal" action="__APP__/Home/Inc/reg" method="post">
					...
					<div class="modal-footer">
						 <button type="submit" class="btn btn-primary btn-lg btn-block" style="border-radius:0px;">免费注册</button>
					</div>
				</form>
			</div>
		</div>
...
<a href="__APP__/Home/Index"><img src="__IMG__/logo.png" height="48px" width="130px" alt="数据牛-泄露信息查询"></a>
		</div>	
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav" style="font-size:16px">
				
				<li><a onclick="javascript:$('#feedback').modal('toggle');" style="cursor:pointer">反馈</a></li>
				<li><a href="__APP__/Home/About">关于</a></li>
				<li><a href="__APP__/World">English</a></li>
			</ul>
