	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content" style="width:380px;">
			...
			<div class="modal-body">
				<form role="form" class="form-horizontal" action="__APP__/World/Inc/cklogin" method="post">
...
<a href="__APP__/World/Index"><img src="__IMG__/logo_en.png"></a>
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right" style="font-size:16px">
				...
				<else/>	
				<li><a onclick="javascript:$('#login').modal('toggle');" style="cursor:pointer">Login</a></li>
